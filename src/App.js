...
// https://omdbapi.com/?t=the avengers&apikey=ba6aae7a
...
function App() {
  ...
  useEffect(() =>{
   ...
   function getMovieData(){
    ...
    let url=`https://omdbapi.com/?t=${title}&apikey=ba6aae7a`;
        ...
        <h1>Movie Search</h1>
         ...
         <div className="movie"> 
           <div className="poster">
             <img src={movieinfo?.Poster} alt="Movie Poster" className="img-poster" />
           </div>
           <div className="details">
             <div className="padd">
               ...
               <p><strong>Duration</strong>: {movieinfo?.Runtime}</p>
